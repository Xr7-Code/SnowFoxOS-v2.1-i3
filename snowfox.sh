...
cmd_update() {
    ...
    # yt-dlp separat aktualisieren — kommt nicht über apt
...
cmd_stream() {
    ...
    fox "Starte Stream..."
    mpv --vo=wlshm --ytdl "$URL" 2>/dev/null || mpv --ytdl "$URL"
}
...
cmd_battery() {
    ...
    # Energie in Watt — power_now oder current_now * voltage_now
    POWER_UW=0
    ...
    # Kapazität in Wh — energy oder charge*voltage
    ENERGY_NOW=0
    ENERGY_FULL=0
